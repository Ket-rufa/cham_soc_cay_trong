...
class PlantCategoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(context.tr('plantList.title')),
        backgroundColor: Colors.white,
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              labelText: context.tr('plantList.searchHint'),
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(context.tr('plantList.empty'),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                          plant['difficulty'] ??
                              context.tr('plantList.difficultyFallback'),
                          style: const TextStyle(
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                            plant['light'] ??
                                context.tr('plantList.sunFallback'),
                            style: const TextStyle(
                                fontSize: 10, color: Colors.grey),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis),
